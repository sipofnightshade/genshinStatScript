import charactersStats from "../data/charactersStats.json";
import charactersCurve from "../data/charactersCurve.json";
 ...
 */
export function getPromotionBonus(promotions, level, ascension) {
 ...
 */
export function calcStatsForCharacter(filename, levelstr) {
